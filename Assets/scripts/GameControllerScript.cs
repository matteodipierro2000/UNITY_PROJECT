...
public class GameControllerScript : MonoBehaviour //we extend the MonoBehaviour class (class to manage game objects)
                                                  //with the class GameControllerScript
{
    ...
    [SerializeField] private Main startObject; //reference for the 1st card-->we will link to this variable the star sprite.
                                               //We notice also that
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < columns; i++)
        {
            ...
            {
                Main gameImage; //gameImage is variable that we will put equal to startObject and so to the star card.  It is a Main variable because 
                ...
                {
                    gameImage = Instantiate(startObject) as Main; //the next object is created equal to the 1st card
                }
    ...
    private Main firstOpen;
    private Main secondOpen;
    public int keys;
    ...
    public void imageOpened(Main startObject) //this function is called in the main function when the user open a card
    {
